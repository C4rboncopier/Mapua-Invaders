...
public class Level4 implements Screen, InputProcessor{
	...
	private Texture alienArrayTexture;
    ...
    private boolean alien1DirectionRight = true;
    private boolean alien2DirectionRight = false;
    private boolean alien3DirectionRight = false;
    private boolean alien4DirectionRight = true;
    private boolean alien5DirectionRight = true;
    private boolean alien6DirectionRight = false;
    private boolean alien7DirectionRight = false;
    private boolean alien8DirectionRight = false;
    private boolean alien9DirectionRight = false;
    ...
    public static int PLAYER_SPEED4 = Level3.PLAYER_SPEED3;
    public static int BULLET_SPEED4 = Level3.BULLET_SPEED3;
    public static float BULLET_DELAY_TIME = Level3.BULLET_DELAY_TIME;
    private static int ALIEN_BULLET_SPEED1 = 700;
    private float alienSpeed = 200f;
	private static int score = 1800;
	public static int livesRemaining2 = Level3.livesRemaining2;
    ...
    private ArrayList<Sprite> alienArray;
	...
	public void show() {
        ...
        //gif background
        animation = GifDecoder.loadGIFAnimation(Animation.PlayMode.LOOP, Gdx.files.internal("background/Level4.gif").read());
		
		//choice 1
		choiceTexture1 = new Texture("powerup/level4/LivesPlus1.png");
		Choice1 = new Sprite(choiceTexture1);
		Choice1.setCenter(Gdx.graphics.getWidth() - 1000, Gdx.graphics.getHeight() / 2f);
		
		//choice 2
		choiceTexture2 = new Texture("powerup/level4/Playerspeed.png");
		Choice2 = new Sprite(choiceTexture2);
		Choice2.setCenter(Gdx.graphics.getWidth() / 2f, Gdx.graphics.getHeight() / 2f);
		
		//choice 3
		choiceTexture3 = new Texture("powerup/level4/Bulletspeed.png");
		Choice3 = new Sprite(choiceTexture3);
		Choice3.setCenter(Gdx.graphics.getWidth() - 280, Gdx.graphics.getHeight() / 2f);
		
		//start
		countTexture = new Texture(Gdx.files.internal("level/level4.png"));
        ...
        //alien
        alienTexture = new Texture(Gdx.files.internal("character/Alien4.png"));
        
        //alien array
        alienArrayTexture = new Texture(Gdx.files.internal("character/Alienarray4.png"));
        ...
        for (int i = 0; i < numRows; i++) {
        	for (int j = 0; j < numCols; j++) {
        		Sprite alienarray = new Sprite(alienArrayTexture);
        		alienarray.setSize(alienarray.getWidth() * 9 / 2, alienarray.getHeight() * 9 / 2);
        		float xPos = (Gdx.graphics.getWidth() / 2 - ((numCols * (alienarray.getWidth() + xPadding)) / 2) + xPadding + j * (alienarray.getWidth() + xPadding));
                float yPos = (Gdx.graphics.getHeight() / 2) + yPadding + (i * (alienarray.getHeight() + yPadding)) - 100;
                alienarray.setPosition(xPos, yPos);
                alienArray.add(alienarray);
        	}
        }
        ...
        alien5.setPosition(Gdx.graphics.getWidth() / 2 - alien5.getWidth() / 2 + 400, Gdx.graphics.getHeight() / 2 + 200);
        ...
        alien7.setPosition(Gdx.graphics.getWidth() / 2 - alien7.getWidth() / 2 - 420, Gdx.graphics.getHeight() / 2 + 90);
        ...
        //alien bullet
        alienBulletTexture = new Texture(Gdx.files.internal("weapon/alienBullet4.png"));
        ...
        //congratulations
        congratulationsTexture = new Texture(Gdx.files.internal("text/labTask4.png"));
        ...
        //background music
        BackgroundMusic = Gdx.audio.newMusic(Gdx.files.internal("Music/Level4.wav"));
        ...
        Explosion2 = Gdx.audio.newMusic(Gdx.files.internal("Music/Sound/Level3Alien.wav"));
        Explosion2.setVolume(explosionMusicDb);
	...
	public void render(float delta) {
		...
		if (!ContinueClicked) {
        	...
        	Stats.draw(batch, "Player Speed:   " + PLAYER_SPEED4, Gdx.graphics.getWidth() - 800, Gdx.graphics.getHeight()- 5);
        	Stats.draw(batch, "Bullet Speed:   " + BULLET_SPEED4, Gdx.graphics.getWidth() - 500, Gdx.graphics.getHeight()- 5);
		}
			...
			if (elapsedTime <= 1) {
				...
				if (!isPlayerDead && elapsedTime > 2) {
					...
					if(alienBulletDelayTime1 >= ALIEN_BULLET_DELAY_TIME_1 && alien1Touched == false) {
						...
						bullet1.setPosition(alien1.getX() + 5, Gdx.graphics.getHeight() / 2 + 68);
						bullet1.setSize(bullet1.getWidth() * 7 / 2, bullet1.getHeight() * 7 / 2);
					...
					if(alienBulletDelayTime2 >= ALIEN_BULLET_DELAY_TIME_2 && alien2Touched == false) {
						...
						bullet2.setPosition(alien2.getX() + 5, Gdx.graphics.getHeight() / 2 + 78);
						bullet2.setSize(bullet2.getWidth() * 7 / 2, bullet2.getHeight() * 7 / 2);
					...
					if(alienBulletDelayTime3 >= ALIEN_BULLET_DELAY_TIME_3 && alien3Touched == false) {
						...
						bullet3.setPosition(alien3.getX() + 5, Gdx.graphics.getHeight() / 2 + 238);
						bullet3.setSize(bullet3.getWidth() * 7 / 2, bullet3.getHeight() * 7 / 2);
					...
					if(alienBulletDelayTime4 >= ALIEN_BULLET_DELAY_TIME_4 && alien4Touched == false) {
						...
						bullet4.setPosition(alien4.getX() + 5, Gdx.graphics.getHeight() / 2 + 148);
						bullet4.setSize(bullet4.getWidth() * 7 / 2, bullet4.getHeight() * 7 / 2);
					...
					if(alienBulletDelayTime5 >= ALIEN_BULLET_DELAY_TIME_5 && alien5Touched == false) {
						...
						bullet5.setPosition(alien5.getX() + 5, Gdx.graphics.getHeight() / 2 + 178);
						bullet5.setSize(bullet5.getWidth() * 7 / 2, bullet5.getHeight() * 7 / 2);
					...
					if(alienBulletDelayTime6 >= ALIEN_BULLET_DELAY_TIME_6 && alien6Touched == false) {
						...
						bullet6.setPosition(alien6.getX() + 5, Gdx.graphics.getHeight() / 2 + 228);
						bullet6.setSize(bullet6.getWidth() * 7 / 2, bullet6.getHeight() * 7 / 2);
					...
					if(alienBulletDelayTime7 >= ALIEN_BULLET_DELAY_TIME_7 && alien7Touched == false) {
						...
						bullet7.setPosition(alien7.getX() + 5, Gdx.graphics.getHeight() / 2 + 68);
						bullet7.setSize(bullet7.getWidth() * 7 / 2, bullet7.getHeight() * 7 / 2);
					...
					if(alienBulletDelayTime8 >= ALIEN_BULLET_DELAY_TIME_8 && alien8Touched == false) {
						...
						bullet8.setPosition(alien8.getX() + 5, Gdx.graphics.getHeight() / 2 + 188);
						bullet8.setSize(bullet8.getWidth() * 7 / 2, bullet8.getHeight() * 7 / 2);
					...
					if(alienBulletDelayTime9 >= ALIEN_BULLET_DELAY_TIME_9 && alien9Touched == false) {
						...
						bullet9.setPosition(alien9.getX() + 5, Gdx.graphics.getHeight() / 2 + 238);
						bullet9.setSize(bullet9.getWidth() * 7 / 2, bullet9.getHeight() * 7 / 2);
					...
					if(alienBulletDelayTime10 >= ALIEN_BULLET_DELAY_TIME_10 && alien10Touched == false) {
						...
						bullet10.setPosition(alien10.getX() + 5, Gdx.graphics.getHeight() / 2 + 58);
						bullet10.setSize(bullet10.getWidth() * 7 / 2, bullet10.getHeight() * 7 / 2);
					...
					//draw alien array
					for(Sprite alienarray : alienArray) {
						alienarray.draw(batch);
					}
				}
			}
		}
	...
	private void handleInput(float delta) {
        if (Gdx.input.isKeyPressed(com.badlogic.gdx.Input.Keys.A) || Gdx.input.isKeyPressed(com.badlogic.gdx.Input.Keys.LEFT)) {
            if (player.getX() > 0) { // Check if player is not at the left edge of the screen
                player.translateX(-PLAYER_SPEED4);
                damagedPlayer.translateX(-PLAYER_SPEED4);
            }
        }
	...
	private void update(float delta) {
        ...
        for (int i = 0; i < bullets.size(); i++) {
        	...
        	bulletMain.translateY(BULLET_SPEED4 * delta);
        ...
        if (elapsedTime > 2) {
            ...
            //moves the alien array
            for (int i = 0; i < alienArray.size(); i++) {
            	Sprite alienarray = alienArray.get(i);
            	alienarray.translateX(alienDirectionRight ? alienSpeed * delta: -alienSpeed * delta);
            	if (alienarray.getX() + alienarray.getWidth() >= screenBounds.getWidth()) {
                    alienDirectionRight = !alienDirectionRight;
            	}
            	else if (alienarray.getX() <= 0) {
            		alienDirectionRight = !alienDirectionRight;
            	}
            }
        }
        ...
        for (int i = 0; i < bullets.size(); i++) {
        	...
        	if (bulletMain.getBoundingRectangle().overlaps(alien1.getBoundingRectangle())) {
        		...
        		alien1Touched = true;
        		score += 60;
        		alien1.setPosition(Gdx.graphics.getWidth() / 2 - alien1.getWidth() / 2 + 60, Gdx.graphics.getHeight() / 2 + 1280);
        	}
        	//alien2
        		...
        		alien2Touched = true;
        		score += 60;
        		alien2.setPosition(Gdx.graphics.getWidth() / 2 - alien2.getWidth() / 2 + 60, Gdx.graphics.getHeight() / 2 + 1280);
        	}
        	//alien3
        		...
        		alien3Touched = true;
        		score += 60;
        		alien3.setPosition(Gdx.graphics.getWidth() / 2 - alien3.getWidth() / 2 + 60, Gdx.graphics.getHeight() / 2 + 1280);
        	}
        	//alien4
        		...
        		alien4Touched = true;
        		score += 60;
        		alien4.setPosition(Gdx.graphics.getWidth() / 2 - alien4.getWidth() / 2 + 60, Gdx.graphics.getHeight() / 2 + 1280);
        	}
        	//alien5
        		...
        		alien5Touched = true;
        		score += 60;
        		alien5.setPosition(Gdx.graphics.getWidth() / 2 - alien5.getWidth() / 2 + 60, Gdx.graphics.getHeight() / 2 + 1280);
        	}
        	//alien6
        		...
        		alien6Touched = true;
        		score += 60;
        		alien6.setPosition(Gdx.graphics.getWidth() / 2 - alien6.getWidth() / 2 + 60, Gdx.graphics.getHeight() / 2 + 1280);
        	}
        	//alien7
        		...
        		alien7Touched = true;
        		score += 60;
        		alien7.setPosition(Gdx.graphics.getWidth() / 2 - alien7.getWidth() / 2 + 60, Gdx.graphics.getHeight() / 2 + 1280);
        	}
        	//alien8
        		...
        		alien8Touched = true;
        		score += 60;
        		alien8.setPosition(Gdx.graphics.getWidth() / 2 - alien8.getWidth() / 2 + 60, Gdx.graphics.getHeight() / 2 + 1280);
        	}
        	//alien9
        		...
        		alien9Touched = true;
        		score += 60;
        		alien9.setPosition(Gdx.graphics.getWidth() / 2 - alien9.getWidth() / 2 + 60, Gdx.graphics.getHeight() / 2 + 1280);
        	}
        	//alien10
        		...
        		alien10Touched = true;
        		score += 60;
        		alien10.setPosition(Gdx.graphics.getWidth() / 2 - alien10.getWidth() / 2 + 60, Gdx.graphics.getHeight() / 2 + 1280);
        	}
        }
        ...
        for (int i = 0; i < bullets.size(); i++) {
            ...
            for (int j = 0; j < alienArray.size(); j++) {
                Sprite alienarray = alienArray.get(j);
                if (bullet.getBoundingRectangle().overlaps(alienarray.getBoundingRectangle())) {
                    bullets.remove(i);
                    alienArray.remove(j);
                    Explosion2.play();
                    score += 20;
	...
	public boolean touchDown(int screenX, int screenY, int pointer, int button) {
		...
		if (!isChoiceClicked) {
		    ...
		    if (restart.getBoundingRectangle().contains(screenX, Gdx.graphics.getHeight() - screenY) && !screenChanged) {
		        ...
		        PLAYER_SPEED4 = Level2.PLAYER_SPEED;
		        BULLET_SPEED4 = Level2.BULLET_SPEED;
		    ...
		    if (Continue.getBoundingRectangle().contains(screenX, Gdx.graphics.getHeight() - screenY) && !screenChanged) {
		    	Win.stop();
		    	Select.play();
		        Level5.livesRemaining2 = livesRemaining2;
		        Level5.PLAYER_SPEED5 = PLAYER_SPEED4;
		        Level5.BULLET_SPEED5 = BULLET_SPEED4;
		        Level5.BULLET_DELAY_TIME = BULLET_DELAY_TIME;
